...
/**
 * Create easy-mv3-react/labs/converted-components.ts automaticlly from @material/web repo in github.
 */
...
fs.outputFile(
  nodePath.resolve("../easy-mv3-react/labs/converted-components.ts"),
  code
);
